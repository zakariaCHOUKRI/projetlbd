...
ingenior_info = Program("ing cs", "bngrir", "um6p-cs.ma", "0811", "cs@um6p.ma", "2021", list_of_courses, list_of_students)
cs = School("cs", "bngrir", "um6p-cs.ma", "0811", "cs@um6p.ma", "2018", list_of_programs)
